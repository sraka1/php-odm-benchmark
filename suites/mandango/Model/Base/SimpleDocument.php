...
/**
 * Base class of Model\SimpleDocument document.
 */
abstract class SimpleDocument extends \Mandango\Document\Document
{
    /**
     ...
     *
     * @return Model\SimpleDocument The document (fluent interface).
     */
