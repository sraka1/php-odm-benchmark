...
/**
 * Base class of repository of Model\SimpleDocument document.
 */
abstract class SimpleDocumentRepository extends \Mandango\Repository
{
    protected $documentClass = 'Model\\SimpleDocument';
    protected $isFile = false;
    protected $connectionName;
    protected $collectionName = 'model_simple_document';
