...
/**
 * Base class of repository of Model\Document document.
 */
abstract class DocumentRepository extends \Mandango\Repository
{
    protected $documentClass = 'Model\\Document';
    protected $isFile = false;
    protected $connectionName;
    protected $collectionName = 'model_document';
