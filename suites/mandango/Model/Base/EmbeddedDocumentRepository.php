...
/**
 * Base class of repository of Model\EmbeddedDocument document.
 */
abstract class EmbeddedDocumentRepository extends \Mandango\Repository
{
    protected $documentClass = 'Model\\EmbeddedDocument';
    protected $isFile = false;
    protected $connectionName;
    protected $collectionName = 'model_embedded_document';
